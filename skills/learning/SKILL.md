---
name: learning
description: Teach or resume learning with GNOS; route a doubt, lesson, or course through the relevant teacher, subject, and learner evidence.
---
...
Use `skills/understanding-user-learning/SKILL.md` when recording or interpreting
