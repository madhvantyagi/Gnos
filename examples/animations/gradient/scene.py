...
class GradientStep(Scene):
    def construct(self):
        ...
        loss=DecimalNumber(4,mob_class=Text,num_decimal_places=2,font_size=32,color=YELLOW)
        ...
        slope=Text('initial slope = 4',font_size=20,color=ORANGE).move_to(RIGHT*4+DOWN*.3)
